...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo "  ./buildworld.sh --help          Show build system help"
    echo "  ./buildworld.sh --host all      Build with local compilation"
    echo "  ./buildworld.sh --cluster all   Build with icecc distributed compilation"
    echo ""
