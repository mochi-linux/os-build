...
SOURCES_LIST=(
    ...
    "https://mirror.mochilinux.org/gnu/parted/parted-3.6.tar.xz"
    "https://github.com/Kitware/CMake/releases/download/v4.3.1/cmake-4.3.1.tar.gz"

    # CLI tools

    "https://github.com/fastfetch-cli/fastfetch/archive/refs/tags/2.61.0.tar.gz"
    "https://github.com/aristocratos/btop/archive/refs/tags/v1.4.6.tar.gz"
)
